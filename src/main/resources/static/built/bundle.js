...
function (_React$Component) {
  ...
  function App(props) {
    ...
    _this.handleChange = _this.handleChange.bind(_assertThisInitialized(_this)); // this.refs.search.focus();
  ...
  _createClass(App, [{
    ...
    value: function handleChange() {
      ...
      if (newSearchString.trim() === "") {
        ...
        fetch("http://localhost:8080/search/" + newSearchString).then(function (res) {
          return res.json();
        }).then(function (data) {
          console.log({
            data: data
    ...
    value: function componentDidMount() {
      ...
      fetch("http://localhost:8080/search/mythology").then(function (res) {
        return res.json();
      }).then(function (data) {
        console.log({
          data: data
    ...
    value: function render() {
      return React.createElement("div", null, React.createElement("h1", null, "Library Management System"), React.createElement("div", null, React.createElement("input", {
        type: "text",
    ...
    value: function render() {
      var searchResults = this.props.searchResults.map(function (searchResult) {
        return React.createElement(SearchResult, {
          key: searchResult.bookAuthorMap.book.isbn13,
          searchResult: searchResult
        });
      });
      return React.createElement("table", null, React.createElement("tbody", null, React.createElement("tr", null, React.createElement("th", null, "Isbn 13"), React.createElement("th", null, "Book Title"), React.createElement("th", null, "Author"), React.createElement("th", null, "Publisher"), React.createElement("th", null, "Availability")), searchResults));
    }
  }]);
...
function (_React$Component3) {
  ...
  _createClass(SearchResult, [{
    key: "render",
    value: function render() {
      return React.createElement("tr", null, React.createElement("td", null, this.props.searchResult.bookAuthorMap.book.isbn13), React.createElement("td", null, this.props.searchResult.bookAuthorMap.book.title), React.createElement("td", null, this.props.searchResult.bookAuthorMap.author.name), React.createElement("td", null, this.props.searchResult.bookAuthorMap.book.publisher), React.createElement("td", null, this.props.searchResult.bookAvailableForBorrowing));
    }
  }]);
